<template>
  ...
  >
    ...
    <div :class="loading ? 'bk-loading-wrapper' : ''">
      <i
        class="bk-icon left-icon"
        :class="['icon-' + iconType, iconType === 'loading' ? 'bk-button-icon-loading' : '']"
        v-if="iconType"
      >
      ...
      <span><slot></slot></span>
      <i
        class="bk-icon right-icon"
        :class="['icon-' + iconRightType, iconRightType === 'loading' ? 'bk-button-icon-loading' : '']"
        v-if="iconRightType"
      >
